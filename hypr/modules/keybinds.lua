...
hl.bind(mainMod .. " + ESCAPE", hl.dsp.exec_cmd("hyprctl dispatch 'hl.dsp.submap(\"keybinds_off\")'"))
...
hl.bind(
	mainMod .. " + S",
	hl.dsp.exec_cmd(
		'grim -g "$(slurp)" - | wl-copy --type image/png && notify-send -i camera-photo "Screenshot copied"'
	)
)
hl.bind(
	mainMod .. " + SHIFT + S",
